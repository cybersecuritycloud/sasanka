...
build = {
   type = "builtin",
   modules = {
      ["kong.plugins.ssk-allowkey.daos"] = "kong/plugins/ssk-allowkey/daos.lua",
      ["kong.plugins.ssk-allowkey.handler"] = "kong/plugins/ssk-allowkey/handler.lua",
      ["kong.plugins.ssk-allowkey.schema"] = "kong/plugins/ssk-allowkey/schema.lua",
      ["kong.plugins.ssk-core.common"] = "kong/plugins/ssk-core/common.lua",
      ["kong.plugins.ssk-core.core"] = "kong/plugins/ssk-core/core.lua",
      ["kong.plugins.ssk-core.decoder"] = "kong/plugins/ssk-core/decoder.lua",
      ["kong.plugins.ssk-core.lib.matcher"] = "kong/plugins/ssk-core/lib/matcher.lua",
      ["kong.plugins.ssk-core.lib.ssk"] = "kong/plugins/ssk-core/lib/ssk.lua",
